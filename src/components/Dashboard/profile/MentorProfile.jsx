            ...
            (<div className='profile_div flex z-20  items-center gap-x-5 justify-between '>
                ...
                <div className='flex bg-white flex-col border-[1px] items-center gap-y-3 rounded-[9px] p-5 lg:w-[300px] lg:h-[560px]'>
                    <fieldset className='flex items-center w-full border-[1px] flex-wrap lg:flex-nowrap p-2  rounded-md'>
                        <legend className='px-2 font-bold'><i>Professional Details</i></legend>
                   ...
                   <legend className='px-2 font-bold'><i>Degree</i></legend>
                   <p className='text-sm'>{profileDetails?.additionalDetails?.education?.degree ? profileDetails?.additionalDetails?.education?.degree : "No Data Found" }</p>
                   </fieldset>
                   <fieldset className='flex items-center w-full border-[1px] p-2 rounded-md'>
                   <legend className='px-2 font-bold'><i>Category</i></legend>
                   <p className='text-sm'>{profileDetails?.category?.name ? profileDetails?.category?.name : "No Data Found"}</p>
                   </fieldset>
                   <fieldset className='flex items-center w-full border-[1px] p-2 rounded-md'>
